...
export default function FocusAreasPage() {
  ...
  return (
    <div className="w-full bg-white">
      ...
      {/* 2. Section 1: Education (Pure White Row) */}
      <section className="w-full bg-white py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionReveal
            direction="up"
            delay={0.06}
            className="rounded-2xl sm:rounded-3xl bg-white p-6 sm:p-10 border border-gray-100/90 shadow-md shadow-gray-200/40 hover:shadow-xl hover:shadow-gray-300/50 transition-all duration-500 group"
          >
            <div className="flex flex-col lg:grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              
              {/* Left Image: education1.webp */}
              <div className="w-full lg:col-span-5 relative h-56 sm:h-72 lg:h-[280px] overflow-hidden rounded-xl sm:rounded-2xl shadow-sm border border-gray-100">
                <Image
              ...
              <div className="w-full lg:col-span-7 space-y-4">
                <div className="space-y-1.5">
                  <h2 className="font-serif text-2xl sm:text-3xl font-bold text-[#356877] group-hover:text-[#DFA528] transition-colors duration-300">
                    Education
                  </h2>
                  <div className="h-0.5 w-14 bg-[#DFA528] transition-all duration-500 group-hover:w-24" />
      ...
      {/* 3. Section 2: Healthcare (Subtle Slate Tint #F8FAFC Row) */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex flex-col lg:grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="w-full lg:col-span-5 lg:order-2 relative h-56 sm:h-72 lg:h-[280px] overflow-hidden rounded-xl sm:rounded-2xl shadow-sm border border-gray-100">
                <Image
      ...
      {/* 5. Section 4: Rural Development (Subtle Slate Tint #F8FAFC Row) */}
      <section className="w-full bg-[#F8FAFC] py-12 sm:py-16 border-y border-gray-100/80">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionReveal
            direction="up"
